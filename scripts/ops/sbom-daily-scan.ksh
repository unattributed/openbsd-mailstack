...
SOURCE_FILE="${REPO_ROOT}/.work/advanced/sbom/source.spdx.json"
INVENTORY_FILE="${REPO_ROOT}/.work/advanced/sbom/host-inventory-${HOST_NAME}.json"
REPORT_JSON="${REPO_ROOT}/.work/advanced/sbom/scan-report.json"
REPORT_TXT="${REPO_ROOT}/.work/advanced/sbom/scan-report.txt"
