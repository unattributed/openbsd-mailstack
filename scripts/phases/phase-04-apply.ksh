...
save_configs_if_requested() {
  ...
  write_kv_config "${DOMAINS_CONF}"     "PRIMARY_DOMAIN="${PRIMARY_DOMAIN}""     "DOMAINS="${DOMAINS}""     "INITIAL_MAILBOXES="${INITIAL_MAILBOXES}""     "DOMAIN_ADMIN_EMAIL="${DOMAIN_ADMIN_EMAIL}""     "POSTFIX_VIRTUAL_TRANSPORT="${POSTFIX_VIRTUAL_TRANSPORT}""
