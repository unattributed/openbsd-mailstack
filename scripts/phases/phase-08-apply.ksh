...
save_configs_if_requested() {
  ...
  write_named_config "${NETWORK_CONF}"     "LAN_INTERFACE" "${LAN_INTERFACE:-em0}"     "WAN_INTERFACE" "${WAN_INTERFACE:-em1}"     "LAN_IPV4" "${LAN_IPV4:-192.168.1.10}"     "LAN_CIDR" "${LAN_CIDR:-24}"     "ENABLE_WIREGUARD" "${ENABLE_WIREGUARD}"     "WIREGUARD_INTERFACE" "${WIREGUARD_INTERFACE}"     "WIREGUARD_SUBNET" "${WIREGUARD_SUBNET}"     "WEB_VPN_ONLY" "${WEB_VPN_ONLY}"
