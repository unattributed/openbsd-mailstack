...
| Phase 03, PostfixAdmin and SQL wiring | PostfixAdmin deployment and schema wiring | `phase-03-postfixadmin-and-sql-wiring` | Partial. Public generated examples exist, but full sanitized service assets are still limited. |
