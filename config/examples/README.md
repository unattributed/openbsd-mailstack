...
2. create real local values in ignored paths such as `config/system.conf` or `config/local/`
3. store provider credentials in ignored files, not in tracked examples
